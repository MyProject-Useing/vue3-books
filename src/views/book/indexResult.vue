<template>
  <div class="video-index-wrap">
    <a-spin :spinning="refreshLoading">
      <div class="video-index-panle">
        ...
        <div class="qy-mod-list">
          <ul class="qy-mod-ul">
            <li class="qy-mod-li" v-for="item in movie" :key="item.name">
              <a
                class="qy-mod-link"
                href="javascript:0;"
                @click="goDetails(item)"
        ...
        <div class="qy-mod-list">
          <ul class="qy-mod-ul">
            <li class="qy-mod-li" v-for="item in variety" :key="item.name">
              <a
                class="qy-mod-link"
                href="javascript:0;"
                @click="goDetails(item)"
...
export default {
  ...
  computed: {
    ...
    tv() {
      return this.bookList.tv ?? [];
    },
    movie() {
      return this.bookList.movie ?? [];
    },
    variety() {
      return this.bookList.variety ?? [];
    },
  },
  mounted() {
    this.init();
