        ...
        <div class="content-nav-wrap">
          <Spin :spinning="bookLoading">
            <Tabs v-model:activeKey="activeKey">
              ...
              >
              <TabPane key="2" force-render class="catalog-tab">
                <template #tab>
...
<script>
import { message, Image, Spin, Tabs, TabPane, BackTop } from "ant-design-vue";
...
export default {
  name: "bookIndex",
  components: { catalog, Image, Spin, Tabs, TabPane, BackTop },
  data() {
    return {
      activeKey: "1",
      bookLoading: false,
